...
namespace ASPNET.StarterKit.Portal
{
    ...
    public class HtmlTextItem : IHtmlTextItem
    {
        ...
        /// <summary>
        ///   <l zh-CN="拥有该 HTML 内容的模块实例标识，同时也是旧表主键。" en="Module instance identifier that owns this HTML content and also serves as the legacy table key." />
        /// </summary>
        [Key]
        public int ModuleId { get; set; }

        /// <summary>
        ///   <l zh-CN="桌面端 HTML 正文；展示层按受信任 HTML 边界输出。" en="Desktop HTML body; presentation code emits it according to the trusted HTML boundary." />
        /// </summary>
        public string DesktopHtml { get; set; }

        /// <summary>
        ///   <l zh-CN="历史移动端摘要字段，当前作为兼容数据保留。" en="Legacy mobile summary field retained as compatibility data." />
        /// </summary>
        public string MobileSummary { get; set; }

        /// <summary>
        ///   <l zh-CN="历史移动端详情字段，当前主题体系不直接依赖。" en="Legacy mobile details field not directly used by the current theme system." />
        /// </summary>
