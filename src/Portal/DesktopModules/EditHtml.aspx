...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <%--
    <lang>
      <zh-CN>P7.4.2-E 将受信任 HTML 配置页改为主题化表单；原始 HTML 的安全边界仍由权限、审计和未来治理机制共同承担。</zh-CN>
      <en>P7.4.2-E rebuilds the trusted HTML settings page with a themed form while keeping the raw-HTML security boundary in permissions, audit trails, and future governance.</en>
    </lang>
    --%>
        ...
        <div class="portal-detail-card portal-edit-form">
            ...
            <div class="portal-field-stack">
                ...
                <lang>
                  ...
                  <en>Allows trusted administrators to enter raw HTML. Ordinary request validation must remain disabled here, otherwise the legacy Web Forms postback cannot save real HTML fragments.</en>
                </lang>
                --%>
