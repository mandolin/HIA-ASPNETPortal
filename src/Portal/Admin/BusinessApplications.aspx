    ...
    <div class="portal-admin-page portal-admin-business-applications">
        <div class="portal-admin-header">
            <div class="portal-admin-heading">
                <h1 class="Head portal-admin-title"><%= lang.Admin_BusinessApplications_Title %></h1>
                <p class="Normal portal-admin-subtitle"><%= lang.Admin_BusinessApplications_Subtitle %></p>
            </div>
            <%= PortalNavigationEntryRenderer.RenderActions("Admin.Capability.BusinessApplications", Context) %>
        </div>
        ...
        <div class="portal-admin-section portal-filter-panel">
            ...
            <div class="portal-filter-grid">
                <div class="portal-filter-field">
                    <span class="SubHead portal-filter-label"><%= lang.Admin_BusinessApplications_LabelStatus %></span>
                ...
                <div class="portal-filter-actions">
                    <asp:Button
                        ID="SearchButton"
                        Text="<%$ Resources:lang, Admin_BusinessApplications_ButtonSearch %>"
        ...
        <div class="portal-admin-section">
            <div class="portal-section-header">
                <h2 class="Head portal-section-title"><%= lang.Admin_BusinessApplications_SectionApplicationRequests %></h2>
            </div>
                            ...
                            <tr class="Normal">
                                ...
                                <td>
                                    <div class="portal-value-stack">
                                        <div><span class="SubHead"><%= lang.Admin_BusinessApplications_InlineTitle %></span> <%#: Eval("Title") %></div>
                                        <div><span class="SubHead"><%= lang.Admin_BusinessApplications_InlineCategory %></span> <%#: Eval("CategoryKey") %></div>
                                        <div><span class="SubHead"><%= lang.Admin_BusinessApplications_InlineSummary %></span> <%#: Eval("Summary") %></div>
                                        <div><span class="SubHead"><%= lang.Admin_BusinessApplications_InlineBody %></span> <%#: Eval("Body") %></div>
                                        <div><span class="SubHead"><%= lang.Admin_BusinessApplications_InlineLatestReview %></span> <%#: Eval("ReviewText") %></div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    ...
                                    <div class="portal-row-actions">
                                        <asp:Button ID="ApproveButton" Text="<%$ Resources:lang, Admin_BusinessApplications_ButtonApprove %>" CssClass="CommandButton" CommandName="Approve" CommandArgument='<%# Eval("ApplicationId") %>' CausesValidation="False" runat="server" />
                                        <asp:Button ID="ReturnButton" Text="<%$ Resources:lang, Admin_BusinessApplications_ButtonReturn %>" CssClass="CommandButton" CommandName="Return" CommandArgument='<%# Eval("ApplicationId") %>' CausesValidation="False" runat="server" />
                                        <asp:Button ID="RejectButton" Text="<%$ Resources:lang, Admin_BusinessApplications_ButtonReject %>" CssClass="CommandButton CommandButtonDanger" CommandName="Reject" CommandArgument='<%# Eval("ApplicationId") %>' CausesValidation="False" runat="server" />
                                    </div>
                                </td>
                            </tr>
                    </ItemTemplate>
