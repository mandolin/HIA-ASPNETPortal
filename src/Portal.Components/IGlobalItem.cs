namespace ASPNET.StarterKit.Portal
{
    ...
    {
        /// <summary>
        ///   <l zh-CN="门户标识；旧站点通常使用单门户记录。" en="Portal identifier; the legacy site usually uses one portal row." />
        /// </summary>
        int PortalId { get; set; }

        /// <summary>
        ///   <l zh-CN="展示在站点外壳中的门户名称。" en="Portal name displayed in the site shell." />
        /// </summary>
        string PortalName { get; set; }

        /// <summary>
        ///   <l zh-CN="是否始终显示模块编辑按钮；空值按旧数据兼容策略由调用方解释。" en="Whether module edit buttons are always shown; callers interpret null according to legacy-data compatibility policy." />
        /// </summary>
