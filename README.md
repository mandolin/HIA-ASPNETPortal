...
项目的开发、配置、主题、模块、测试和部署文档见 [中文文档 / Documentation](docs/README.md)。
...
For development, configuration, theme, module, testing, and deployment guidance, see [Documentation / 中文文档](docs/README.md).
